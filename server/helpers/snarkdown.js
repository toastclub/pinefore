 ...
 *
 * Snarkdown is *not* used to render user-generated content, as it is vulnerable to XSS attacks.
 *
 * It is used to render markdown content that is written by the developer, inside a compile-time macro.
 *
 * */
export default function snarkdown(markdown) {
  return markdown
    .split(/(?:\r?\n){2,}/)
    .map((l) =>
